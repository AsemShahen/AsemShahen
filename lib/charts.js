...
function factoryAdditions() {
  return [
    ...
    a('5110', 'مصروفات تصنيع مباشرة أخرى', 'expense', 'production', { parent_code: '5' }),
    ...
    a('5116', 'إيجار ومصاريف المصنع', 'expense', 'production', { parent_code: '5' }),
    a('5117', 'كهرباء ومياه ووقود المصنع', 'expense', 'production', { parent_code: '5' }),
    a('5118', 'إهلاك آلات ومعدات الإنتاج', 'expense', 'production', { parent_code: '5' }),
    a('5119', 'مصروفات تصنيع غير مباشرة أخرى', 'expense', 'production', { parent_code: '5' })
  ];
}
...
// ---------- إضافات المشفى ----------
function hospitalAdditions() {
  return [
    a('1206', 'ذمم المرضى (حسابات مدينة)', 'asset', 'receivable', { parent_code: '11', normal_side: 'debit', is_system: 1 }),
    a('1207', 'ذمم شركات التأمين الصحي', 'asset', 'receivable', { parent_code: '11', normal_side: 'debit' }),
    a('1315', 'مخزون الأدوية', 'asset', 'inventory', { parent_code: '11' }),
    a('1316', 'مخزون المستلزمات الطبية', 'asset', 'inventory', { parent_code: '11' }),
    a('1510', 'الأجهزة الطبية التشخيصية (أشعة، رنين)', 'asset', 'fixed_asset', { parent_code: '15' }),
    a('4114', 'إيرادات الكشف والاستشارات', 'revenue', 'sales', { parent_code: '4', normal_side: 'credit' }),
    a('4115', 'إيرادات المختبر والأشعة والفحوصات', 'revenue', 'sales', { parent_code: '4', normal_side: 'credit' }),
    a('4116', 'إيرادات العمليات الجراحية', 'revenue', 'sales', { parent_code: '4', normal_side: 'credit' }),
    a('4117', 'إيرادات الإقامة والتنويم', 'revenue', 'sales', { parent_code: '4', normal_side: 'credit' }),
    a('4118', 'إيرادات الصيدلية والأدوية', 'revenue', 'sales', { parent_code: '4', normal_side: 'credit' }),
    a('4119', 'إيرادات الطوارئ', 'revenue', 'sales', { parent_code: '4', normal_side: 'credit' }),
    a('4120', 'إيرادات أخرى للمشفى', 'revenue', 'sales', { parent_code: '4', normal_side: 'credit' }),
    a('5217', 'الأدوية والمستهلكات الصيدلانية', 'expense', 'admin', { parent_code: '5' }),
    a('5218', 'المستلزمات الطبية', 'expense', 'admin', { parent_code: '5' }),
    a('5219', 'أجور الأطباء والاستشاريين', 'expense', 'admin', { parent_code: '5' }),
    a('5220', 'أجور التمريض والكوادر الصحية', 'expense', 'admin', { parent_code: '5' })
  ];
}

// ---------- إضافات المطاعم والكفيهات ----------
function restaurantAdditions() {
  return [
    a('1115', 'صندوق الكاشير والوردية', 'asset', 'cash', { parent_code: '11' }),
    a('1317', 'مخزون المواد الأولية (خام)', 'asset', 'inventory', { parent_code: '11' }),
    a('1318', 'مخزون الوجبات والمشروبات الجاهزة', 'asset', 'inventory', { parent_code: '11' }),
    a('1509', 'معدات المطبخ والكافيه', 'asset', 'fixed_asset', { parent_code: '15' }),
    a('4122', 'إيرادات المطعم والكافيه', 'revenue', 'sales', { parent_code: '4' }),
    a('4123', 'إيرادات التوصيل والطلبات الخارجية', 'revenue', 'sales', { parent_code: '4' }),
    a('5116', 'هدر وتلف المواد الغذائية', 'expense', 'production', { parent_code: '5' }),
    a('5117', 'تكلفة المبيعات - المطعم والكافيه', 'expense', 'cogs', { parent_code: '5' })
  ];
}

// ---------- إضافات الفنادق والضيافة (فندق / شقق مفروشة) ----------
function hotelAdditions() {
  return [
    a('1116', 'صندوق الاستقبال', 'asset', 'cash', { parent_code: '11' }),
    a('1208', 'ذمم النزلاء (حسابات مدينة)', 'asset', 'receivable', { parent_code: '11', normal_side: 'debit', is_system: 1 }),
    a('1319', 'مخزون مستلزمات الضيافة', 'asset', 'inventory', { parent_code: '11' }),
    a('1511', 'أثاث وتجهيزات الغرف والوحدات', 'asset', 'fixed_asset', { parent_code: '15' }),
    a('4130', 'إيرادات إيجار الغرف والوحدات', 'revenue', 'sales', { parent_code: '4', normal_side: 'credit' }),
    a('4131', 'إيرادات الخدمات الفندقية', 'revenue', 'sales', { parent_code: '4', normal_side: 'credit' }),
    a('4132', 'إيرادات أخرى للفندق', 'revenue', 'other_income', { parent_code: '4', normal_side: 'credit' }),
    a('5118', 'تكلفة الخدمات الفندقية', 'expense', 'cogs', { parent_code: '5' }),
    a('5221', 'مستلزمات الضيافة والتنظيف', 'expense', 'admin', { parent_code: '5' }),
    a('5222', 'مصروفات تشغيل الغرف والوحدات', 'expense', 'admin', { parent_code: '5' })
  ];
}
...
function getChartForType(businessType) {
  ...
  const extra = {
    ...
    hospital: hospitalAdditions,
    restaurant: restaurantAdditions,
    hotel: hotelAdditions
  }[businessType];
